import { ITicketsOverview, OrganizerDashboardFilter } from "../../../../domain/interface/organizer-dashboard/dashboard";
...
export class GetTicketsOverviewUseCase implements IGetTicketsOverviewUseCase {
  ...
  async execute(organizerId: string, filter?:OrganizerDashboardFilter): Promise<ITicketsOverview> {
