import { SubscriptionPlansFilter, SubscriptionPlanPaginatedResult } from "../../../../domain/interface/admin-finance-query/subcription";
...
export class GetSubscriptionPlansUseCase implements IGetSubscriptionPlansUseCase {
  ...
  async execute(filter: SubscriptionPlansFilter): Promise<SubscriptionPlanPaginatedResult> {
