...
import { TransactionsFilter, TransactionPaginatedResult } from "../../../../domain/interface/admin-finance-query/transactions";
...
export class GetTransactionsUseCase implements IGetTransactionsUseCase {
 ...
 async execute(filter: TransactionsFilter): Promise<TransactionPaginatedResult> {
