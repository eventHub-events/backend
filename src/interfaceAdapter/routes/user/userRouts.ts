...
} from '../../../di/user/booking/container';
...
router.post(
  '/register',
  InputDataValidator.validate(userRegisterSchema),
...
router.post(
  ...
  (req: IAuthenticatedRequest, res: Response, next: NextFunction) =>
    tokenController.refreshAccessToken(req, res, next)
);
...
router.post(
  '/resetPasswordOtp',
  (req: IAuthenticatedRequest, res, next: NextFunction) =>
...
router.post(
  ...
  InputDataValidator.validate(userForgetPassWordSchema),
  (req: IAuthenticatedRequest, res: Response, next: NextFunction) =>
...
router.get(
  ...
  (req: IAuthenticatedRequest, res: Response, next: NextFunction) =>
    userProfileController.fetchUserProfile(req, res, next)
);
router.patch(
  '/:profileId/profile',
  InputDataValidator.validate(userProfileUpdateSchema),
  (req: IAuthenticatedRequest, res: Response, next: NextFunction) =>
...
router.get(
  EventDisplayRoutes.EVENTS.TRENDING,
  (req: Request, res: Response, next: NextFunction) =>
    eventDisplayController.getTrending(req, res, next)
);
router.get(
  EventDisplayRoutes.EVENTS.FEATURED,
  (req: Request, res: Response, next: NextFunction) =>
    eventDisplayController.getFeatured(req, res, next)
);
router.get(
  EventDisplayRoutes.EVENTS.DETAILS,
  (req: Request, res: Response, next: NextFunction) =>
    eventDisplayController.getEventDetailsById(req, res, next)
);
router.get(
  '/events/featured/all',
  InputDataValidator.validateQuery(EventSearchQuerySchema),
  (req: Request, res: Response, next: NextFunction) =>
    eventDisplayController.getAllFeatured(req, res, next)
);
router.get(
  '/search/events',
  InputDataValidator.validateQuery(EventSearchQuerySchema),
  (req: Request, res: Response, next: NextFunction) =>
    eventDisplayController.getEventsForGeneralSearch(req, res, next)
);
...
router.post(
  ...
  authenticationMiddleWare.authenticateUser.bind(authenticationMiddleWare),
  (req: IAuthenticatedRequest, res: Response, next: NextFunction) =>
    eventBookingController.bookTickets(req, res, next)
);
router.get(
  '/bookings/session/:sessionId',
  authenticationMiddleWare.authenticateUser.bind(authenticationMiddleWare),
  (req: Request, res: Response, next: NextFunction) =>
    getUserBookingsController.getBookingBySessionId(req, res, next)
);
router.get(
  '/:userId/bookings',
  ...
  authenticationMiddleWare.authenticateUser.bind(authenticationMiddleWare),
  (req: Request, res: Response, next: NextFunction) =>
    getUserBookingsController.getUserBookings(req, res, next)
);
router.get(
  '/bookings/:bookingId',
  (req: Request, res: Response, next: NextFunction) =>
    getUserBookingsController.getBookingById(req, res, next)
);
router.patch(
  '/bookings/cancel/:bookingId',
  authenticationMiddleWare.authenticateUser.bind(authenticationMiddleWare),
  (req: IAuthenticatedRequest, res: Response, next: NextFunction) =>
    eventBookingController.cancelPaidBooking(req, res, next)
);
...
router.post(
  '/google-login',
  (req: Request, res: Response, next: NextFunction) =>
    googleAuthController.googleLogin(req, res, next)
);
...
router.post(
  ...
  authenticationMiddleWare.authenticateUser.bind(authenticationMiddleWare),
  (req: Request, res: Response, next: NextFunction) =>
    bookingPaymentController.createSession(req, res, next)
);
...
router.get(
  ...
  authenticationMiddleWare.authenticateUser.bind(authenticationMiddleWare),
  (req: IAuthenticatedRequest, res: Response, next: NextFunction) =>
    chatController.getUserEventChats(req, res, next)
);
...
router.post(
  ...
  authenticationMiddleWare.authenticateUser.bind(authenticationMiddleWare),
  (req: IAuthenticatedRequest, res: Response, next: NextFunction) =>
    reportController.createEventReport(req, res, next)
);
router.post(
  '/report/organizer',
  authenticationMiddleWare.authenticateUser.bind(authenticationMiddleWare),
  (req: IAuthenticatedRequest, res: Response, next: NextFunction) =>
    reportController.createOrganizerReport(req, res, next)
);
