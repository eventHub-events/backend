...
const updateSubscriptionPlanUseCase = new UpdateSubscriptionPlansUseCase(
  subscriptionPlansRepository,
  subscriptionPlansMapper
);
const updateSubscriptionPlanStatusUseCase =
  new UpdateSubscriptionPlanStatusUseCase(subscriptionPlansRepository);
export const subscriptionPlansManagementController =
  new SubscriptionPlansManagementController(
    createSubscriptionPlanUseCase,
    updateSubscriptionPlanUseCase,
    updateSubscriptionPlanStatusUseCase
  );

const fetchSubscriptionPlansUseCase = new FetchSubscriptionPlansUseCase(
  subscriptionPlansRepository,
  subscriptionPlansMapper
);
export const subscriptionPlansRetrievalController =
  new SubscriptionPlansRetrievalController(fetchSubscriptionPlansUseCase);
