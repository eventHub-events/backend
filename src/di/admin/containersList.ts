...
} from '../organizer/container';

const userMapper = new UserMapper();
export const fetchUserUseCase = new FetchUserUseCase(
  userRepository,
  userMapper
);
...
export const downloadPdfController = new DownloadPdfController(
  downloadPdfUseCase
);
...
const organizerVerificationUseCase = new OrganizerVerificationUseCase(
  organizerProfileRepository,
  uploadDocumentRepository,
  userRepository,
  userQueryRepository,
  organizerVerificationMapper,
  userMapper
);
export const organizerVerificationController =
  new OrganizerVerificationController(organizerVerificationUseCase);
