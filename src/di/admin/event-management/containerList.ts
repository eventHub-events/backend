...
const getAllEventUseCaseByAdmin = new GetAllEventAdminUseCase(
  eventQueryRepository,
  eventAdminViewMapper
);

export const eventManagementQueryController =
  new EventManagementQueryController(getAllEventUseCaseByAdmin);

const createEventModerationUseCase = new CreateEventModerationUseCase(
  eventModerationRepository,
  eventModerationMapper
);
const updateEventModerationUseCase = new UpdateEventModerationUseCase(
  eventModerationRepository,
  eventModerationMapper,
  eventRepository
);
const fetchEventModerationByEventIdUseCase =
  new FetchEventModerationByEventIdUseCase(
    eventModerationRepository,
    eventModerationMapper
  );

// admin-actions
const approveEventUseCase = new ApproveEventUseCase(
  eventModerationRepository,
  eventModerationMapper,
  eventRepository
);
const rejectEventUseCase = new RejectEventUseCase(
  eventModerationRepository,
  eventModerationMapper,
  eventRepository
);
const blockEventUseCase = new BlockEventUseCase(
  eventModerationRepository,
  eventModerationMapper,
  eventRepository
);
const unBlockEventUseCase = new UnblockEventUseCase(
  eventModerationRepository,
  eventModerationMapper,
  eventRepository
);
export const eventModerationActionsController =
  new EventModerationActionsController(
    approveEventUseCase,
    rejectEventUseCase,
    blockEventUseCase,
    unBlockEventUseCase
...
export const eventModerationController = new EventModerationController(
  createEventModerationUseCase,
  updateEventModerationUseCase,
  fetchEventModerationByEventIdUseCase
);
