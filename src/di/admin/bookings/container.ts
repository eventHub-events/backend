...
const getUserBookingByIdForAdminUseCase = new GetUserBookingByIdForAdminUseCase(
  bookingRepository,
  bookingMapper
);
const getAllBookingsForAdminUseCase = new GetAllBookingsForAdminUseCase(
  bookingRepository,
  bookingMapperAdmin
);
export const bookingControllerForAdmin = new BookingControllerForAdmin(
  getAllBookingsForAdminUseCase,
  getUserBookingByIdForAdminUseCase
);
