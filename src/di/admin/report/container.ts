...
import { eventRepository, nodeMailerEmailService, userRepository } from "../../common/commonContainers";
...
const adminActionTakenUseCase = new AdminActionTakenUseCase(reportRepository, eventRepository,userRepository, reportModerationEmailTemplate, nodeMailerEmailService);
const getReportUseCase = new GetReportsUseCase(reportRepository, reportMapper);
export const adminReportController = new AdminReportController(getReportUseCase, adminActionTakenUseCase);