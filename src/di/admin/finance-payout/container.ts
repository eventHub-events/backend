...
const getSubscriptionOverviewUseCase = new GetSubscriptionOverviewUseCase(
  financeRepo
);
export const getFinanceOverviewController = new GetFinanceAndPayoutController(
  getFinanceOverviewUseCase,
  getTransactionsUseCase,
  getRefundsUseCase,
  getRefundOverviewUseCase,
  getPayoutsUseCase,
  getPayoutOverviewUseCase,
  eventRevenueSummaryUseCase,
...
const exportTransactionsReportUseCase = new ExportTransactionsReportUseCase(
  financeRepo,
  pdfReportService
);
export const exportFinancePayoutPDFController =
  new ExportFinancePayoutPDFController(exportTransactionsReportUseCase);
