...
const getCommunityChatUseCase = new GetCommunityChatUseCase(
...
const startPrivateChatUseCase = new StartPrivateChatUseCase(
  conversationRepository,
  conversationMapper,
  userRepository
);
export const sendMessagesUseCase = new SendMessageUseCase(
  messageRepository,
  conversationRepository,
  messageMapper
);
const getOrganizerChatEventUseCase = new GetOrganizerChatEventUseCase(
  conversationRepository,
  conversationMapper,
  messageRepository
);
...
const getUserChatEventUseCase = new GetUserChatEventUseCase(
  messageRepository,
  conversationRepository,
  conversationMapper
);
...
export const chatController = new ChatController(
  startPrivateChatUseCase,
  getCommunityChatUseCase,
  getMessagesUseCase,
  sendMessagesUseCase,
  getOrganizerChatEventUseCase,
  getUserChatEventUseCase
);
