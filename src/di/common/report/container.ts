...
const createChatMessageUseCase = new CreateChatMessageReportUseCase(messageRepository, conversationRepository, reportRepository, reportMapper);

export const reportController = new ReportController(createOrganizerReportUseCase, createEventReportUseCase, createChatMessageUseCase);
