...
const getBookingDetailsByIdUseCase = new GetBookingDetailsByIdUseCase(
  bookingRepository,
  bookingDetailsByIdMapper
);
const getBookingsByEventIdUseCase = new GetAllBookingsByEventIdUseACase(
  bookingRepository,
  bookingMapper
);
export const bookingsDisplayController = new BookingsDisplayController(
  getAllBookingsUseCase,
  getBookingDetailsByIdUseCase,
  getBookingsByEventIdUseCase
);
