...
const processPayoutUseCase = new ProcessPayoutUseCase(bookingRepository, stripe);
export const payoutSchedulerJob = new PayoutSchedulerJob(undefined,processPayoutUseCase);
