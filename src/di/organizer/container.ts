...
const organizerProfileUseCase = new OrganizerProfileUseCase(
  organizerProfileRepository,
  userRepository
);
export const organizerProfileController = new OrganizerProfileController(
...
const uploadDocumentsMapper = new UploadDocumentsMapper(
  organizerUploadDocumentMapper
);
const uploadDocumentFactory = new UploadDocumentFactory();
export const uploadDocumentRepository = new UploadDocumentRepository(
  loggerService,
...
export const documentVerificationRequestController =
  new OrganizerDocumentVerificationRequestController(
    verificationRequestUseCase
  );

const organizerAccountSecurityUseCase = new OrganizerAccountSecurityUseCase(
  userRepository,
  hashService
);
export const organizerAccountSecurityController =
  new OrganizerAccountSecurityController(organizerAccountSecurityUseCase);
