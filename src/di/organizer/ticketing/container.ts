...
const createTicketingUseCase = new CreateTicketingUseCase(
  ticketingRepository,
  ticketingMapper
);
const updateTicketingUseCase = new UpdateTicketingUseCase(
  ticketingRepository,
  ticketingMapper
);
const fetchTicketingUseCase = new FetchTicketingUseCase(
  ticketingRepository,
  ticketingMapper
);
const fetchTicketingByEventUseCase = new FetchTicketingDetailsByEventUseCase(
  ticketingRepository,
  ticketingMapper
);

// ----------controller dependency injection----------//
export const ticketingManagementController = new TicketingManagementController(
  createTicketingUseCase,
  updateTicketingUseCase
);
export const ticketingRetrievalController = new TicketingRetrievalController(
  fetchTicketingUseCase,
  fetchTicketingByEventUseCase
);
