...
const getUserBookingByIdUseCase = new GetUserBookingByIdUseCase(
  bookingRepository,
  bookingMapper
);
const getBookingBySessionId = new GetUserBookingBySessionId(
  bookingRepository,
  bookingMapper
);
export const getUserBookingsController = new GetUserBookingsController(
  getUserBookingsListUseCase,
  getUserBookingByIdUseCase,
  getBookingBySessionId
);

const releaseExpiredBookingsUseCase = new ReleaseExpiredBookingsUseCase(
  bookingRepository,
  ticketingRepository
);
...
export const eventBookingController = new EventBookingController(
  bookTicketUseCase,
  cancelPaidBookingUseCase
);
