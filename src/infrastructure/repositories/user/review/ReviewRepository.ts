...
import {
  IReview,
  ReviewModel,
} from '../../../db/models/common/review/ReviewModel';
...
{
  constructor(private _reviewEntityFactory: IReviewEntityFactory) {
    super(ReviewModel);
  }
  ...
  async findReviewByUserAndTarget(
    userId: string,
    targetId: string,
