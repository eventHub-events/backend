...
} from '../../../db/models/user/UserProfile';
...
export class UserProfileRepository
  extends BaseRepository<IUserProfileDocument>
  implements IUserProfileRepository
{
  /**
   * @constructor
   ...
   */
  constructor(private _profileEntityFactory: IUserProfileEntityFactory) {
  ...
  async updateProfile(
    ...
    const updatedData = (await super.update(
      profileId,
      profileData
