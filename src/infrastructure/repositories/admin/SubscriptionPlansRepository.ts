...
} from '../../db/models/admin/SubscriptionPlansModel';
import { BaseRepository } from '../BaseRepository';

export class SubscriptionPlansRepository
  extends BaseRepository<ISubscriptionPlans>
  implements ISubscriptionPlansRepository
{
  constructor(
    private _subscriptionEntityFactory: ISubscriptionEntityFactory<
      SubscriptionPlansDbModel,
  ...
  async fetchSubscriptionPlanById(
    ...
    const fetchedData = (await super.findById(
      subscriptionId
    )) as SubscriptionPlansDbModel;
  ...
  async fetchSubscriptionPlans(
    ...
    const fetchedPlans = (await super.findAll(
      filterOption
    )) as SubscriptionPlansDbModel[];
