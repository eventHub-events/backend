...
export const organizerProfileSchema = z. object({
  ...
  organization: z
    ...
    .regex(/^[A-Z][a-zA-Z\s]*$/, {
      message: "Organization must start with a capital letter and contain only letters/spaces",
    })
    .optional(),
  ...
  profilePicture: z
    ...
    {
      message: "Must be an empty string or a valid image URL ending in .jpg, .jpeg, .png, or .webp",
    }
  )
    .optional(),
