...
> {
  toDomain(dbModel: BookingDbModel): BookingEntity {
    return new BookingEntity({
      ...
      eventStartDate: dbModel.eventStartDate,
      eventEndDate: dbModel.eventEndDate,
      eventStartTime: dbModel.eventStartTime,
      eventEndTime: dbModel.eventEndTime,
      attendanceDate:dbModel.attendanceDate,
