export const ResponseMessages = {
  ...
  EVENT_MODERATION : {
   ...
   EVENT_MODERATION_CREATION_SUCCESS : "Moderation details created successfully",
  ...
  GENERAL: {
   ...
   FINANCE_PAYOUT : {
    ...
    STRIP_CONNECT : {
      ...
      ON_BOARDING_STATUS_VERIFICATION_SUCCESS :"Onboarding Status verified successfully"
    },
    ...
    ORGANIZER_VERIFICATION : {
      ORGANIZER_VERIFICATION_DETAILS_FETCH_SUCCESS : "Organizer Verification  details fetched successfully",
      PENDING_ORGANIZERS_FETCH_SUCCESS : "Pending organizers fetched successfully",
      PENDING_ORGANIZERS_WITH_PROFILE_FETCH_SUCCESS : "Pending organizers with profile fetched successfully",
      ORGANIZER_OVERALL_VERIFICATION_STATUS_UPDATE_SUCCESS : "Organizer overall verification status updated successfully",
