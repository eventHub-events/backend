...
export const privateChatSocketService = new PrivateChatSocketService(
  privateChatNamespace,
  sendMessagesUseCase,
  markMessagesAsReadUseCase
);
export const communityChatSocketService = new CommunityChatSocketService(
  communityChatNamespace
);
